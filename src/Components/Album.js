        ...
        <React.Fragment>
            ...
            <footer className={classes.footer}>
                <Typography variant="h6" align="center" gutterBottom>
                    <i class="fas fa-users"></i>  Recent Supporters
        </Typography> 
                <Typography variant="subtitle1" align="center" color="textSecondary" component="p">
                    <i class="fas fa-user-plus"></i> Brian Smith  $8 {/* /* {this.props} */}
                    <br/>
                    <i class="fas fa-user-plus"></i> Sarah Lee $7.21
                    <br />
                    <i class="fas fa-user-plus"></i> Ella Cody $3.99
        </Typography>
            </footer>
            {/* End footer */}
        </React.Fragment>
